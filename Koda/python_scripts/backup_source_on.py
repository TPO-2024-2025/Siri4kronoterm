...
try:
    ...
    logger.info("Starting backup heat source activation")
    ...
    if heat_pump_state is None:
        ...
        message = "Heat pump is currently turned off. Cannot activate backup heat source."
        ...
        # Heat pump is on, proceed with activating backup heat source
        logger.info("Activating backup heat source")
        ...
        logger.info("Backup heat source activated")
        
        # Prepare notification message
        message = "Backup heat source has been activated"
        
        # Create persistent notification in Home Assistant UI
        hass.services.call('persistent_notification', 'create', {
            'title': 'Backup Heat Source Activation',
            'message': message,
            'notification_id': 'backup_heat_source_notification'
        })
    ...
    # Log any errors
    error_msg = f"Error in backup heat source activation script: {str(e)}"
    logger.error(error_msg)
    hass.services.call('persistent_notification', 'create', {
        'title': 'Backup Heat Source Script Error',
        'message': error_msg,
